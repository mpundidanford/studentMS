    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'AdminHOD'), (2, 'staffs'), (3, 'student')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staffs_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.staffs')),
            ],
        ),
        migrations.CreateModel(
            name='Students',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('subject_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='student.subjects')),
            ],
        ),
        migrations.CreateModel(
            name='AdminHoD',
